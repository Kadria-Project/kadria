...
const isAcceptedQuote = (quote: Row) => quote.accepted === true || text(quote.accepted_at) !== null || ACCEPTED_QUOTE_STATUSES.has(normalizedStatus(quote.statut || quote.status))
