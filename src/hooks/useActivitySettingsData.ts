...
export type BusinessProfile = { primaryTrade: string; coveredTrades: string[]; specialties: string[]; excludedServices: string[]; baseCity: string; interventionRadiusKm: string; travelFeeHt: string; travelFeePerKm: string }
