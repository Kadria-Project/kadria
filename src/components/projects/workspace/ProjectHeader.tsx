...
export function ProjectHeader({ brief, capabilities, navigation }: { brief: ProjectWorkspaceBrief; capabilities: ProjectWorkspaceCapabilities; navigation: ProjectWorkspaceNavigation }) {
  ...
  const actions = [{ label: 'Modifier le dossier', capability: capabilities.editProject }, { label: 'Faire avancer le commercial', capability: capabilities.managePipeline }, { label: 'Planifier un rendez-vous', capability: capabilities.createAppointment }, { label: 'Ouvrir l’agenda', capability: capabilities.openAgenda }, { label: 'PDF', capability: capabilities.pdf, icon: FileText }, { label: 'Portail client', capability: capabilities.portal }, { label: 'Acompte', capability: capabilities.payment }, { label: 'Demander un avis', capability: capabilities.review }, { label: 'Envoyer un SMS', capability: capabilities.sms }];
