...
import DevelopmentWebVitals, { webVitalsEnabled } from './DevelopmentWebVitals';
...
export default function KadriaAppShell({ children }: { children: ReactNode }) {
  return <WorkspaceNavigationProvider>{webVitalsEnabled() && <DevelopmentWebVitals />}<NavigationPerformanceProbe /><KadriaAppShellLayout>{children}</KadriaAppShellLayout></WorkspaceNavigationProvider>;
}
