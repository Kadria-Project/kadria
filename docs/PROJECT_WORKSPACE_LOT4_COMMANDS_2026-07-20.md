...
- tests Projet, contrat de commande et garde : **13/13 réussis** ;
- lint ciblé : **0 erreur** ; 13 avertissements préexistants du contrôleur legacy, sans nouvel avertissement de ce sous-lot ;
- `npx tsc --noEmit` : **réussi** ;
- `git diff --check` : **réussi** ;
- `npm run build` : **réussi en 90,8 s** (compilation Turbopack 37,1 s, TypeScript 43 s, génération statique 1,853 s).
