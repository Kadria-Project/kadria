...
| Dossiers (liste) | onglet "Suivi commercial", vue Liste | `dossiers-01-liste-normal-desktop.png`, `dossiers-02-liste-dense-desktop.png`, `dossiers-03-liste-empty-desktop.png`, `dossiers-05-filtres-desktop.png` | `dossiers-04-liste-mobile.png` | normal / dense / empty | Clic onglet, clic "Liste", recherche "Martin" (1 résultat confirmé), scroll | Vu |
